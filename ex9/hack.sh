...
# Run a loop to check if the output contains 'BOOM!', if it does, add 1 to the second number in the fourth line of the solution file and run the vault program again
while true; do
