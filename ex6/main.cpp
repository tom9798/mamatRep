...
int main() {
    ...
    std::cout << "str1: " << str1.as_string().c_str() << std::endl;

    // Test copy constructor
    String str2(str1);
    std::cout << "str2 (copy of str1): " << str2.as_string().c_str() << std::endl;

    // Test operator=
    str2 = "Goodbye, World!";
    std::cout << "str2 (after assignment): " << str2.as_string().c_str() << std::endl;
    ...
    String str5("   Trim me!   ");
    str5.trim();
    std::cout << "str5 (after trim): \"" << str5.as_string().c_str() << "\"" << std::endl;
    ...
    for (int i = 0; i < array.size; ++i) {
        std::cout << "  " << array.array[i]->as_string().c_str() << std::endl;
    }
